...
export const carPageStyles = {
  ...
  card: "flex flex-col group relative rounded-2xl overflow-hidden border border-slate-700 shadow-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-1",
  ...
  priceBadge: "hidden",
  priceText: "hidden",
  content: "p-4 sm:p-5 md:p-6 flex flex-col flex-1",
